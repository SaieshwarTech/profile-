...
<div className="overlay">
  <div className="col mobile:text-sm tablet:text-5xl">
    <h2 className="headline">
      <div className="headline-text">A Goan Visionary</div>
    </h2>
    <h2 className="headline">
      <div className="headline-text">Web Dev & Creative Mind</div>
    </h2>
    <h2 className="headline">
      <div className="headline-text">Fueled by Hustle & Code</div>
    </h2>
  </div>
  <div className="col">
    <h2 className="headline">
      <div className="headline-text">
        <span>Click</span> anywhere to unlock the journey
      </div>
    </h2>
  </div>
</div>
