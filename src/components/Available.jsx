...
const Available = ({ project }) => {
  ...
  return (
    ...
    <div className="absolute tablet:-mt-40 right-0 mobile:-mt-12">
      <img src={contactAbstract} alt="Abstract Art" className="mobile:w-28 tablet:w-auto"/>
    </div>
      ...
      <div className="tablet:pt-10 tablet:pl-10 tablet:pr-10 mobile:p-6 rounded-3xl bg-font-color uppercase flex flex-col justify-between grow w-full">
        <div className="flex flex-col tablet:items-start mobile:text-6xl mobile:items-start mobile:ml-0 tablet:ml-0 grow">
          ...
          <p className="text-bg-color tablet:-mt-12 tablet:w-2/6 mobile:w-80 tablet:text-left tablet:text-lg mobile:text-sm">
            Want to know more? Let’s dive into the details of this project.
          </p>
        </div>
        <div className="text-bg-color flex tablet:flex-row mobile:flex-col tablet:items-end tablet:justify-between pt-20 font-urbanist font-bold text-lg -mb-3">
          ...
          <p className="mb-5">©all rights reserved. Stay tuned for more.</p>
        </div>
      </div>
    </div>
  </div>
